...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Info.last_name'
        db.alter_column(u'hello_info', 'last_name', self.gf('django.db.models.fields.CharField')(max_length=20))

        # Changing field 'Info.name'
        db.alter_column(u'hello_info', 'name', self.gf('django.db.models.fields.CharField')(max_length=20, null=True))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Info.last_name'
        db.alter_column(u'hello_info', 'last_name', self.gf('django.db.models.fields.CharField')(max_length=10))

        # Changing field 'Info.name'
        db.alter_column(u'hello_info', 'name', self.gf('django.db.models.fields.CharField')(max_length=10, null=True))
    ...
    models = {
        ...
        u'hello.requests': {
            ...
            'date_and_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 6, 5, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
