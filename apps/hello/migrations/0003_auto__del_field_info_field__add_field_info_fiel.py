...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Info.field'
        db.delete_column(u'hello_info', 'field')

        # Adding field 'Info.fiel'
        db.add_column(u'hello_info', 'fiel',
                      self.gf('django.db.models.fields.CharField')(max_length=20, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Info.field'
        db.add_column(u'hello_info', 'field',
                      self.gf('django.db.models.fields.CharField')(max_length=20, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Info.fiel'
        db.delete_column(u'hello_info', 'fiel')
    ...
    models = {
        u'hello.info': {
            ...
            'fiel': ('django.db.models.fields.CharField', [], {'max_length': '20', 'null': 'True', 'blank': 'True'}),
