...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'hello_requests', (
            ...
            ('date_and_time', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2016, 6, 9, 0, 0))),
        ))
    ...
    models = {
        ...
        u'hello.requests': {
            ...
            'date_and_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 6, 9, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
